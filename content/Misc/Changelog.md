...
- Update the appearance tables on character pages
	- Session numbers link to the session for ease of navigation, and only show the session number (Ex: "20" instead of "Session 20") to better fit the table on screen
